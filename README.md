...
- [자동차리콜데이터 수집, 분석, 시각화](https://github.com/dudns1234/TIL/blob/master/8_DataAnalysis/1_%EB%8D%B0%EC%9D%B4%ED%84%B0%EB%B6%84%EC%84%9D.md)
...
> 230914 학습한 내용 정리
- [평가척도](https://github.com/dudns1234/TIL/blob/master/9_MachineLearning.md/5_%ED%8F%89%EA%B0%80%EC%B2%99%EB%8F%84.md) - 선형회귀모델
- [알고리즘](https://github.com/dudns1234/TIL/blob/master/9_MachineLearning.md/6_%EC%95%8C%EA%B3%A0%EB%A6%AC%EC%A6%98.md) - 결정트리, KNN
- [전처리](https://github.com/dudns1234/TIL/blob/master/9_MachineLearning.md/7_%EC%A0%84%EC%B2%98%EB%A6%AC.md) - 인코딩(label 방법)
...
> 230915 학습한 내용 정리
- [전처리](https://github.com/dudns1234/TIL/blob/master/9_MachineLearning.md/7_%EC%A0%84%EC%B2%98%EB%A6%AC.md)- 인코딩(원-핫)
...
> 231025 학습한 내용 정리
- 시각화 코드 수정
- geopandas overlay 사용해서 모든 신고위치와 겹치지 않으면서 도로인 지역 추출 및 시각화
...
> 231106 학습한 내용 정리
- 분산시스템 이론 학습
- SQL 쿼리 작성 : group by, join, SELECT절 문법, 서브쿼리
...
> 231108 학습한 내용 정리
- SQL로 인구데이터 분석, 지하철데이터 분석
- AWS : 인스턴스, 보안그룹, 탄력적 IP
- Python, Java 개발환경 구축하기
- Linux 명령어(진행중)
...
> 231120 학습한 내용 정리
- SparkML 기초
- SparkML로 택시비 예측 모델 생성 - 단일 회귀, 다중 회귀, 하이퍼 파라미터 튜닝
- Airflow 설치 및 확인

> 231121 학습한 내용 정리
- 카카오 API를 활용한 데이터 수집 DAG 생성
- Spark 작업 파이프라인 구성
- 네이버 환율 크롤링 및 저장 pipeline 구축

> 231122 학습한 내용 정리
- kafka 이론 및 설치(주키퍼 및 브로커)
- 토픽 생성을 통해 파티션과 컨슈머 관계 확인
- Kafdrop 사용하기
- 실시간 리뷰 예측
...
> 231127 학습한 내용 정리
- 최종 프로젝트 주제 논의 및 세부내용 작성 (진행중)

> 231128 학습한 내용 정리
- 최종 프로젝트 주제 논의 및 세부내용 작성 (진행중)

> 231129 학습한 내용 정리
- 최종 프로젝트 주제 선정 및 세부내용 작성 (진행중)
